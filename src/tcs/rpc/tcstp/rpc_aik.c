...
TSS_RESULT
tcs_wrap_MakeIdentity2(struct tcsd_thread_data *data)
{
	TCS_CONTEXT_HANDLE hContext;
	TCPA_ENCAUTH identityAuth;
	TCPA_CHOSENID_HASH privCAHash;
	...
	result = TCSP_MakeIdentity2_Internal(hContext, identityAuth, privCAHash, idKeyInfoSize,
					     idKeyInfo, pSRKAuth, pOwnerAuth, &idKeySize, &idKey,
					     &pcIDBindSize, &prgbIDBind);
