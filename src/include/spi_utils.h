...
TSS_RESULT Transport_KeyControlOwner(TSS_HCONTEXT, TCS_KEY_HANDLE, UINT32, BYTE *, UINT32, TSS_BOOL, TPM_AUTH *, TSS_UUID *);
...
struct tcs_api_table {
	...
	TSS_RESULT (*KeyControlOwner)(TSS_HCONTEXT, TCS_KEY_HANDLE, UINT32, BYTE *,
				      UINT32, TSS_BOOL, TPM_AUTH *, TSS_UUID *);
#endif
