...
TSS_RESULT RPC_SetCapability(TSS_HCONTEXT, TCPA_CAPABILITY_AREA,	UINT32, BYTE *, UINT32,
				BYTE *, TPM_AUTH *);
...
TSS_RESULT RPC_MakeIdentity2(TSS_HCONTEXT, TCPA_ENCAUTH, TCPA_CHOSENID_HASH, UINT32, BYTE *,
			     TPM_AUTH *, TPM_AUTH *, UINT32 *, BYTE **, UINT32 *, BYTE **);
...
TSS_RESULT RPC_SetOrdinalAuditStatus(TCS_CONTEXT_HANDLE, TPM_AUTH *, UINT32, TSS_BOOL);
TSS_RESULT Transport_SetOrdinalAuditStatus(TCS_CONTEXT_HANDLE, TPM_AUTH *, UINT32, TSS_BOOL);
TSS_RESULT RPC_GetAuditDigest(TCS_CONTEXT_HANDLE, UINT32, TPM_DIGEST *, UINT32 *, BYTE **, TSS_BOOL *, UINT32 *, UINT32 **);
TSS_RESULT Transport_GetAuditDigest(TCS_CONTEXT_HANDLE, UINT32, TPM_DIGEST *, UINT32 *, BYTE **, TSS_BOOL *, UINT32 *, UINT32 **);
TSS_RESULT RPC_GetAuditDigestSigned(TCS_CONTEXT_HANDLE, TCS_KEY_HANDLE, TSS_BOOL, TPM_NONCE *,
				    TPM_AUTH *, UINT32 *, BYTE **, TPM_DIGEST *, TPM_DIGEST *,
				    UINT32 *, BYTE **);
TSS_RESULT Transport_GetAuditDigestSigned(TCS_CONTEXT_HANDLE, TCS_KEY_HANDLE, TSS_BOOL, TPM_NONCE *,
					  TPM_AUTH *, UINT32 *, BYTE **, TPM_DIGEST *, TPM_DIGEST *,
					  UINT32 *, BYTE **);
TSS_RESULT RPC_SetOperatorAuth(TCS_CONTEXT_HANDLE, TCPA_SECRET *);
TSS_RESULT Transport_SetOperatorAuth(TCS_CONTEXT_HANDLE, TCPA_SECRET *);
TSS_RESULT RPC_OwnerReadInternalPub(TCS_CONTEXT_HANDLE, TCS_KEY_HANDLE, TPM_AUTH *, UINT32 *, BYTE **);
TSS_RESULT Transport_OwnerReadInternalPub(TCS_CONTEXT_HANDLE, TCS_KEY_HANDLE, TPM_AUTH *, UINT32 *, BYTE **);
...
TSS_RESULT RPC_Delegate_Manage(TCS_CONTEXT_HANDLE, TPM_FAMILY_ID, TPM_FAMILY_OPERATION, UINT32, BYTE *, TPM_AUTH *, UINT32 *, BYTE **);
TSS_RESULT RPC_Delegate_CreateKeyDelegation(TCS_CONTEXT_HANDLE, TCS_KEY_HANDLE, UINT32, BYTE *, TPM_ENCAUTH, TPM_AUTH *, UINT32 *, BYTE **);
TSS_RESULT RPC_Delegate_CreateOwnerDelegation(TCS_CONTEXT_HANDLE, TSS_BOOL, UINT32, BYTE *, TPM_ENCAUTH, TPM_AUTH *, UINT32 *, BYTE **);
TSS_RESULT RPC_Delegate_LoadOwnerDelegation(TCS_CONTEXT_HANDLE, TPM_DELEGATE_INDEX, UINT32, BYTE *, TPM_AUTH *);
TSS_RESULT RPC_Delegate_ReadTable(TCS_CONTEXT_HANDLE, UINT32 *, BYTE **, UINT32 *, BYTE **);
TSS_RESULT RPC_Delegate_UpdateVerificationCount(TCS_CONTEXT_HANDLE, UINT32, BYTE *, TPM_AUTH *, UINT32 *, BYTE **);
TSS_RESULT RPC_Delegate_VerifyDelegation(TCS_CONTEXT_HANDLE, UINT32, BYTE *);
