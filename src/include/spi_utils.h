...
TSS_RESULT TCS_EnumRegisteredKeys2(TSS_HCONTEXT, TSS_UUID *, UINT32 *, TSS_KM_KEYINFO2 **);
...
TSS_RESULT TCSP_CreateRevocableEndorsementKeyPair(TSS_HCONTEXT, TPM_NONCE, UINT32, BYTE *, TSS_BOOL,
						TPM_DIGEST *, UINT32 *, BYTE **, TPM_DIGEST *);
TSS_RESULT TCSP_RevokeEndorsementKeyPair(TSS_HCONTEXT, TPM_DIGEST *);
...
TSS_RESULT TCSP_SetTempDeactivated2(TSS_HCONTEXT, TPM_AUTH *);
...
TSS_RESULT TCSP_OwnerReadInternalPub(TCS_CONTEXT_HANDLE, TCS_KEY_HANDLE, TPM_AUTH *, UINT32 *, BYTE **);
TSS_RESULT TCSP_Delegate_Manage(TCS_CONTEXT_HANDLE, TPM_FAMILY_ID, TPM_FAMILY_OPERATION, UINT32, BYTE *, TPM_AUTH *, UINT32 *, BYTE **);
TSS_RESULT TCSP_Delegate_CreateKeyDelegation(TCS_CONTEXT_HANDLE, TCS_KEY_HANDLE, UINT32, BYTE *, TPM_ENCAUTH, TPM_AUTH *, UINT32 *, BYTE **);
TSS_RESULT TCSP_Delegate_CreateOwnerDelegation(TCS_CONTEXT_HANDLE, TSS_BOOL, UINT32, BYTE *, TPM_ENCAUTH, TPM_AUTH *, UINT32 *, BYTE **);
TSS_RESULT TCSP_Delegate_LoadOwnerDelegation(TCS_CONTEXT_HANDLE, TPM_DELEGATE_INDEX, UINT32, BYTE *, TPM_AUTH *);
TSS_RESULT TCSP_Delegate_ReadTable(TCS_CONTEXT_HANDLE, UINT32 *, BYTE **, UINT32 *, BYTE **);
TSS_RESULT TCSP_Delegate_UpdateVerificationCount(TCS_CONTEXT_HANDLE, UINT32, BYTE *, TPM_AUTH *, UINT32 *, BYTE **);
TSS_RESULT TCSP_Delegate_VerifyDelegation(TCS_CONTEXT_HANDLE, UINT32, BYTE *);
