...
enum TCSD_ORD {
	...
	TCSD_ORD_GETCREDENTIALS = 86,
	TCSD_ORD_GETCREDENTIAL = 87,
	/* NV */
	TCSD_ORD_NVDEFINEORRELEASESPACE = 88,
	TCSD_ORD_NVWRITEVALUE = 89,
	TCSD_ORD_NVWRITEVALUEAUTH = 90,
	TCSD_ORD_NVREADVALUE = 91,
	TCSD_ORD_NVREADVALUEAUTH = 92,
	/* Last */
	TCSD_LAST_ORD = 93
