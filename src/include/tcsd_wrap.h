...
enum TCSD_ORD {
	...
	TCSD_ORD_KILLMAINTENANCEARCHIVE = 71,
	TCSD_ORD_LOADMANUFECTURERMAINTENANCEPUB = 72,
	TCSD_ORD_READMANUFECTURERMAINTENANCEPUB = 73,
	/* ATMEL (TBD) */
	TCSD_ORD_ATMEL_SETSTATE = 74,
	TCSD_ORD_ATMEL_OWNERSETSTATE = 75,
	TCSD_ORD_ATMEL_GETSTATE = 76,
	/* NS (TBD) */
	/* Last */
	TCSD_LAST_ORD = 77

};
#define HOW_MANY_ORDINALS TCSD_LAST_ORD
